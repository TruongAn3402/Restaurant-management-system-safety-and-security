 ...
 * @author Admin
 */
public class frm_QLBanAn extends javax.swing.JFrame {
    ...
    public static ArrayList<BanAn> dsba = BanAn_DAO.getDSBAn();
    private frm_QuanLyChung qlc;
    /**
     * Creates new form frm_QLBanAn
     */
    private String layQuyenNV;
    public frm_QLBanAn(String layQuyenNV) {
        initComponents();
    ...
    public void laydulieuBAn(ArrayList<BanAn> dsba) {
        ...
        tb_danhSachBan.setModel(new DefaultTableModel(tblData, tblTitle));
        tb_danhSachBan.updateUI();
    ...
    private void initComponents() {
        ...
        tb_danhSachBan = new javax.swing.JTable();
        ...
        tb_danhSachBan.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tb_danhSachBan.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tb_danhSachBanMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tb_danhSachBan);
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txt_tenBan, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(cb_trangThai, 0, 250, Short.MAX_VALUE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(43, 43, 43)
    ...
    private void tb_danhSachBanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_danhSachBanMouseClicked
        int i = tb_danhSachBan.getSelectedRow();
        String maba = tb_danhSachBan.getValueAt(i, 0).toString().trim();
        String tenba = tb_danhSachBan.getValueAt(i, 1).toString().trim();
        String trangthai = tb_danhSachBan.getValueAt(i, 2).toString().trim();

        txt_maBan.setText(maba);
        txt_tenBan.setText(tenba);
        cb_trangThai.setSelectedItem(trangthai);
    }//GEN-LAST:event_tb_danhSachBanMouseClicked
    ...
    private void btn_xoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_xoaActionPerformed
        String ma = txt_maBan.getText();

        String sql = "DELETE FROM NV001.banan WHERE maban='" + ma + "'";
        if (BanAn_DAO.ThemXoaSuaBanAn(sql) > 0) {
            dsba = BanAn_DAO.getDSBAn();
            laydulieuBAn(dsba);
        }
    ...
    private void btn_suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suaActionPerformed
        String ma = txt_maBan.getText();
        String ten = txt_tenBan.getText();
        String loai = cb_trangThai.getSelectedItem().toString();
        String sql = "UPDATE NV001.banan SET   TrangThai='" + loai + "' WHERE maBAN='" + ma + "'";
        if (BanAn_DAO.ThemXoaSuaBanAn(sql) > 0) {
            dsba = BanAn_DAO.getDSBAn();
            laydulieuBAn(dsba);
        }
    ...
    private void btn_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_themActionPerformed
        if (JOptionPane.showConfirmDialog(this, "Bạn có chắc muốn thêm không?", "Thông báo", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                ...
                String sql = "{CALL NV001.THEMBANAN_AES('"+ma+"','"+ten+"','"+loai+"')";
                if (BanAn_DAO.ThemXoaSuaBanAn(sql) > 0) {
                    dsba = BanAn_DAO.getDSBAn();
                    laydulieuBAn(dsba);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_QLBanAn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_QLBanAn().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tb_danhSachBan;

 ...
 * @author Admin
 */
public class frm_QLMonAn extends javax.swing.JFrame {
    Vector tblData = new Vector();
    Vector tblTitle = new Vector();
    DefaultTableModel tblModel;
    String s1[] = {"Doan", "Nuocuong"};
    ...
    /**
     * Creates new form frm_QLMonAn
     */
    public frm_QLMonAn(String layQuyenNV) {
        initComponents();
    ...
    public void laydulieuMAn(ArrayList<MonAn> dsma) {
        ...
        tb_danhSachMonAn.setModel(new DefaultTableModel(tblData, tblTitle));
        tb_danhSachMonAn.updateUI();
    }
    /**
    ...
    private void initComponents() {
        ...
        tb_danhSachMonAn = new javax.swing.JTable();
        ...
        txt_tenMA = new javax.swing.JTextField();
        btn_xoa = new javax.swing.JButton();
        btn_sua = new javax.swing.JButton();
        btn_them = new javax.swing.JButton();
        txt_giaTien = new javax.swing.JTextField();
        jLabel8 = new javax.swing.JLabel();
        cb_loaiMA = new javax.swing.JComboBox<>();
        ...
        tb_danhSachMonAn.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tb_danhSachMonAn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tb_danhSachMonAnMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tb_danhSachMonAn);
        ...
        cb_loaiMA.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txt_tenMA, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(cb_loaiMA, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(43, 43, 43)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txt_tenMA, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(cb_loaiMA, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btn_taiLaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_taiLaiActionPerformed
        ...
        MonAn_DAO.getDSMAn();
        dsma = MonAn_DAO.getDSMAn(); // Cập nhật danh sách dsnv
        laydulieuMAn(dsma);
    }//GEN-LAST:event_btn_taiLaiActionPerformed

    private void tb_danhSachMonAnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_danhSachMonAnMouseClicked

    }//GEN-LAST:event_tb_danhSachMonAnMouseClicked
    ...
    private void btn_xoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_xoaActionPerformed
        String ma = txt_maMA.getText();

        String sql = "DELETE FROM NV001.monan WHERE mamon='" + ma + "'";
        if (MonAn_DAO.ThemXoaSuaMonAn(sql) > 0) {
            dsma = MonAn_DAO.getDSMAn();
            laydulieuMAn(dsma);
        }
    ...
    private void btn_suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suaActionPerformed
        String ma = txt_maMA.getText();
        String ten = txt_tenMA.getText();
        String loai = cb_loaiMA.getSelectedItem().toString();
        String gia = txt_giaTien.getText();
        String sql = "{CALL NV001.CapNhatMon_AES_SHA('"+ma+"', '"+ten+"', '"+loai+"', '"+gia+"')}";
        if (MonAn_DAO.ThemXoaSuaMonAn(sql) > 0) {
            dsma = MonAn_DAO.getDSMAn();
            laydulieuMAn(dsma);
        }
    ...
    private void btn_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_themActionPerformed
        if (JOptionPane.showConfirmDialog(this, "Bạn có chắc muốn thêm không?", "Thông báo", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            ...
            String ten = txt_tenMA.getText();
            String loai = cb_loaiMA.getSelectedItem().toString();
            int gia = Integer.parseInt(txt_giaTien.getText());
            String sql = "{CALL NV001.ThemMon_AES_SHA('"+ma+"', '"+ten+"', '"+loai+"', '"+gia+"')}";
            if (MonAn_DAO.ThemXoaSuaMonAn(sql) > 0) {
                dsma = MonAn_DAO.getDSMAn();
                laydulieuMAn(dsma);
                MonAn_DAO.getDSMAn();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_QLMonAn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_QLMonAn().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> cb_loaiMA;
    ...
    private javax.swing.JTable tb_danhSachMonAn;
    ...
    private javax.swing.JTextField txt_tenMA;

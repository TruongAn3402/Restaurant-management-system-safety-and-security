 ...
 * @author Admin
 */
public class frm_FGAKhachHang extends javax.swing.JFrame {
    Vector tblData = new Vector();
    Vector tblTitle = new Vector();
    DefaultTableModel tblModel;
    
    String s1[] = {"MAKH", "TENKH", "GIOITINH", "NGAYSINH", "DIACHI", "SODT"};
    DefaultComboBoxModel<String> model = new DefaultComboBoxModel<>(s1);
    
    static ArrayList<DBA_AUDIT_POLICIES> dap = FGAAuditTrail_DAO.LayThongTinChinhSachFGA2();
    private String layQuyenNV;
    /**
     * Creates new form frm_FGAKhachHang
     */
    public frm_FGAKhachHang(String layQuyenNV) {
        initComponents();
        this.setLocationRelativeTo(null);
        
        cbm_auditColumn.setModel(model);
    ...
    private void initComponents() {
        ...
        cbm_auditColumn = new javax.swing.JComboBox<>();
        ...
        txt_objName = new javax.swing.JTextField();
        ...
        cbm_auditColumn.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        txt_objName.setText("KHACHHANG");
        txt_objName.setEnabled(false);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cbm_auditColumn, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(txt_objName, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 27, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(btn_xayDungChinhSach, javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(txt_quyen1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(1, 1, 1)
                        .addComponent(btn_xoaChinhSach, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel1)
                            .addComponent(txt_objName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(cbm_auditColumn, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(20, 20, 20)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btn_xayDungChinhSachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_xayDungChinhSachActionPerformed
        ...
        String object_name = txt_objName.getText().trim();
        String policy_name = txt_policyName.getText().trim();
        String audit_column = cbm_auditColumn.getSelectedItem().toString();
        ...
        if(rdb_select.isSelected()==true){
            ...
            if(FGAAuditTrail_DAO.ThucHienChucNang(sql) > 0 ){
                ...
                FGAAuditTrail_DAO.LayThongTinChinhSachFGA2();
                dap = FGAAuditTrail_DAO.LayThongTinChinhSachFGA2();
                laydulieuFGA(dap);
            }
        }
    ...
    private void btn_taiLaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_taiLaiActionPerformed
        // TODO add your handling code here:
        FGAAuditTrail_DAO.LayThongTinChinhSachFGA2();
        dap = FGAAuditTrail_DAO.LayThongTinChinhSachFGA2(); // Cập nhật danh sách dsnv
        laydulieuFGA(dap);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_FGAKhachHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_FGAKhachHang().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> cbm_auditColumn;
    ...
    private javax.swing.JTextField txt_objName;

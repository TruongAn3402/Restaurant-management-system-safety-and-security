 ...
 * @author Admin
 */
public class frm_PhanQuyen extends javax.swing.JFrame {
     ...
     */
    public frm_PhanQuyen(String layQuyenNV) {
        initComponents();
    ...
    private void initComponents() {
        ...
        cb_thaoTac.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
    ...
    private void btn_capQuyenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_capQuyenActionPerformed
        ...
        if(ckb_select.isSelected()==true){
            String sql = "GRANT SELECT ON NV001."+tenBang+" TO "+ manv;
            String sql2 = "UPDATE NV001.NHANVIEN SET QUYEN = 'Admin' WHERE MaNV = '"+manv+"'";
        ...
        if(ckb_update.isSelected()==true){
            String sql = "GRANT UPDATE ON NV001."+tenBang+" TO "+manv; 
            String sql2 = "GRANT EXECUTE ON NV001.CAPNHATNHANVIEN TO "+ manv;
            if(NhanVien_DAO.ThemXoaSuaNhanVien(sql) == 0 && NhanVien_DAO.ThemXoaSuaNhanVien(sql2) == 0){
                JOptionPane.showMessageDialog(this,"Thành công","Thông báo", JOptionPane.INFORMATION_MESSAGE);
            }            
        }
        if(ckb_insert.isSelected()==true){
            String sql = "GRANT INSERT ON NV001."+tenBang+" TO "+manv;
            String sql2 = "GRANT EXECUTE ON NV001.ThemNhanVien_AES TO " + manv;
            if(NhanVien_DAO.ThemXoaSuaNhanVien(sql) == 0 && NhanVien_DAO.ThemXoaSuaNhanVien(sql2) == 0){
                JOptionPane.showMessageDialog(this,"Thành công","Thông báo", JOptionPane.INFORMATION_MESSAGE);
            }
        }
        if(ckb_delete.isSelected()==true){
            String sql = "GRANT DELETE ON NV001."+tenBang+" TO "+manv;
            String sql2 = "GRANT EXECUTE ON NV001.XoaUser TO " + manv;
            if(NhanVien_DAO.ThemXoaSuaNhanVien(sql) == 0 && NhanVien_DAO.ThemXoaSuaNhanVien(sql2) == 0){
                JOptionPane.showMessageDialog(this,"Thành công","Thông báo", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    ...
    private void btn_thuHoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_thuHoiActionPerformed
        ...
        if(ckb_select.isSelected()==true){
            String sql = "REVOKE SELECT ON NV001."+tenBang+" FROM "+ manv;
        ...
        if(ckb_update.isSelected()==true){
            String sql = "REVOKE UPDATE ON NV001."+tenBang+" FROM "+manv;
            String sql2 = "REVOKE EXECUTE ON NV001.CAPNHATNHANVIEN FROM "+ manv;
            if(NhanVien_DAO.ThemXoaSuaNhanVien(sql) == 0 && NhanVien_DAO.ThemXoaSuaNhanVien(sql2) == 0){
                JOptionPane.showMessageDialog(this,"Thành công","Thông báo", JOptionPane.INFORMATION_MESSAGE);
            }
        }
        if(ckb_insert.isSelected()==true){
            String sql = "REVOKE INSERT ON NV001."+tenBang+" FROM "+manv;
            String sql2 = "REVOKE EXECUTE ON NV001.ThemNhanVien_AES FROM " + manv;
            if(NhanVien_DAO.ThemXoaSuaNhanVien(sql) == 0 && NhanVien_DAO.ThemXoaSuaNhanVien(sql2) == 0){
                JOptionPane.showMessageDialog(this,"Thành công","Thông báo", JOptionPane.INFORMATION_MESSAGE);
            }
        }
        if(ckb_delete.isSelected()==true){
            String sql = "REVOKE DELETE ON NV001."+tenBang+" FROM "+manv;
            String sql2 = "REVOKE EXECUTE ON NV001.XoaUser FROM " + manv;
            if(NhanVien_DAO.ThemXoaSuaNhanVien(sql) == 0 && NhanVien_DAO.ThemXoaSuaNhanVien(sql2) == 0){
                JOptionPane.showMessageDialog(this,"Thành công","Thông báo", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    ...
    private void btn_unlockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_unlockActionPerformed
        ...
        String sql = "ALTER USER "+manv+" ACCOUNT UNLOCK";
    ...
    private void btn_lockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_lockActionPerformed
        // TODO add your handling code here:
        String manv = txt_username.getText().trim();
        String sql = "ALTER USER "+manv+" ACCOUNT LOCK";
            if(NhanVien_DAO.ThemXoaSuaNhanVien(sql) == 0 ){
                JOptionPane.showMessageDialog(this,"Thành công","Thông báo", JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    public ArrayList<DBA_SYS_PRIVS> LoadDuLieuQuyenNV() {
        ...
        String masv = txt_username.getText();
        try {          
            String sql = "SELECT * FROM NV001.DBA_SYS_PRIVS WHERE GRANTEE = '"+ masv +"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_PhanQuyen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_PhanQuyen().setVisible(true);
            }
        });
    }
